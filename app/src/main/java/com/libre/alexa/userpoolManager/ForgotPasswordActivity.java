...
public class ForgotPasswordActivity extends AppCompatActivity {
        ...
        passwordInput.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    passwordInput.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
        ...
        codeInput.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    codeInput.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
    ...
    private void getCode() {
        ...
        if (newPassword == null || newPassword.length() < 1) {
            ...
            passwordInput.setBackground(getResources().getDrawable(R.drawable.text_border_error));
            return;
        }
        ...
        if (verCode == null || verCode.length() < 1) {
            ...
            codeInput.setBackground(getResources().getDrawable(R.drawable.text_border_error));
            return;
        }
