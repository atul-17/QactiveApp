...
public class VerifyActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        if(AppHelper.isEmailAvailable()) {
            if(AppHelper.isEmailVerified()) {
                ...
                reqEmailVerf.setBackground(getResources().getDrawable(R.drawable.button_success));
        ...
        if(AppHelper.isPhoneAvailable()) {
            if(AppHelper.isPhoneVerified()) {
                ...
                reqPhoneVerf.setBackground(getResources().getDrawable(R.drawable.button_success));
    ...
    private void reqEmailCode() {
        attrReqCode = "email";
        reqEmailVerf.setBackground(getResources().getDrawable(R.drawable.button_selected));
    ...
    private void reqPhoneCode() {
        ...
        reqPhoneVerf.setBackground(getResources().getDrawable(R.drawable.button_selected));
    ...
    private void sendVerfCode() {
        ...
        if(code == null) {
            ...
            verifCode.setBackground(getResources().getDrawable(R.drawable.text_border_error));
            return;
        }
        ...
        verifCode.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    verifCode.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
