...
public class ChangePasswordActivity extends AppCompatActivity {
        ...
        currPassword.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if(s.length() == 0) {
                    ...
                    currPassword.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
        ...
        newPassword.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if(s.length() == 0) {
                    ...
                    newPassword.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
    ...
    private void changePassword() {
        ...
        if(cPass == null || cPass.length() < 1) {
            ...
            currPassword.setBackground(getResources().getDrawable(R.drawable.text_border_error));
            return;
        }
        ...
        if(nPass == null || nPass.length() < 1) {
            ...
            newPassword.setBackground(getResources().getDrawable(R.drawable.text_border_error));
            return;
        }
