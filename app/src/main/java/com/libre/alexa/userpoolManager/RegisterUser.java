...
package com.libre.alexa.userpoolManager;
        ...
        username.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    username.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
        ...
        password.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if(s.length() == 0) {
                    ...
                    password.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
        ...
        givenName.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    givenName.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
        ...
        email.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    email.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
        ...
        phone.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    phone.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (usernameInput == null || usernameInput.isEmpty()) {
                    ...
                    username.setBackground(getResources().getDrawable(R.drawable.text_border_error));
                    return;
                }
                ...
                if (userpasswordInput == null || userpasswordInput.isEmpty()) {
                    ...
                    password.setBackground(getResources().getDrawable(R.drawable.text_border_error));
                    return;
                }
