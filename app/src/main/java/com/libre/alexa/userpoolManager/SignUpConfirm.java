...
public class SignUpConfirm extends AppCompatActivity {
        ...
        confCode.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if(s.length() == 0) {
                    ...
                    confCode.setBackground(getResources().getDrawable(R.drawable.text_border_selector));
                }
            }
    ...
    private void sendConfCode() {
        ...
        if(confirmCode == null || confirmCode.length() < 1) {
            ...
            confCode.setBackground(getResources().getDrawable(R.drawable.text_border_error));
            return;
        }
