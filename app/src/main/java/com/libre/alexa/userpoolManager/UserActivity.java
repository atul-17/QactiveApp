...
public class UserActivity extends CTDeviceDiscoveryActivity {
    ...
    private void showLoader() {
        ...
        if (m_progressDlg == null)
            m_progressDlg = ProgressDialog.show(UserActivity.this, getString(R.string.notice), getString(R.string.loading), true, true, null);
    ...
    private void clearAlexaRepo() {
        AlexaLoginRepo.getRepo().signOut();
    }
