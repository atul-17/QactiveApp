...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "us-west-2_arAXZ9B5B";

    /**
     * Add you app id
     */
    private static final String clientId = "1a9i4u2eu595rptfc32kiguimp";
    ...
    private AlexaLoginListener alexaLoginListener ;
