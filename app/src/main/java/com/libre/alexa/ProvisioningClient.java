...
public class ProvisioningClient {
    ...
    public DeviceProvisioningInfo getDeviceProvisioningInfo() throws JSONException, IOException {
        ...
        String locale = response.getString(AuthConstants.LOCALE);

        DeviceProvisioningInfo ret = new DeviceProvisioningInfo(productId, dsn, sessionId, codeChallenge, codeChallengeMethod,locale);
        return ret;
    }
