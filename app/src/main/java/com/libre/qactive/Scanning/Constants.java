...
public class Constants {
    ...
    public static final String WAC_SSID = "Configure_";
    public static final String RIVAA_WAC_SSID = "QActive";

    public static final String WAC_SSID_RIVAA_STADIUM = "QActive_";
    public static final String WAC_SSID_RIVAA_CONCERT = "QActive_";
    public static final String SA_SSID_RIVAA_CONCERT = "QActive_";
    public static final String SA_SSID_RIVAA_STADIUM = "QActive_";
    ...
    public interface ACTION {
        String MAIN_ACTION = "com.libre.qactive.Scanning.action.main";
        String PREV_ACTION = "com.libre.qactive.Scanning.action.prev";
        String PLAY_ACTION = "com.libre.qactive.Scanning.action.play";
        String NEXT_ACTION = "com.libre.qactive.Scanning.action.next";
        String STARTFOREGROUND_ACTION = "com.libre.qactive.Scanning.action.startforeground";
        String STOPFOREGROUND_ACTION = "com.libre.qactive.Scanning.action.stopforeground";
    }
